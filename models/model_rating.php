...
class ModelRating{
    ...
    public function readRatingsByUser(?int $idNoteur):array | string{
        ...
        try{
            ...
            $req = $bdd->prepare('SELECT date_note, note, note.id_page, id_noteur, nom_page FROM note INNER JOIN page_site ON note.id_page = page_site.id_page WHERE id_noteur = ?');
