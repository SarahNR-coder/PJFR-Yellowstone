...
function originalPwdDisplay(){
    if(errMessageObject.errOriginalPwd !=""){
...
originalPwd.addEventListener("keyup", ()=>{
    ...
    clearTimeout(timeout);
    errMessageObject.errOriginalPwd ="";
    originalPwdChecker();
